...
export const BackgroundEl: React.FC = () => {
  ...
  return (
    <section className="absolute bottom-[0rem] lg:top-[20rem]">
      ...
      >
        <div className="">
          <div className="absolute bottom-[17rem] -left-[9rem] sm:bottom-[23.5rem] sm:-left-[14rem] md:bottom-[27.5rem] md:-left-[16rem] lg:-top-[15rem] lg:-left-[12.8rem] xl:-top-[14.5rem] xl:-left-[16rem] 2xl:-top-[16.5rem] 2xl:-left-[17rem] translate-x-3 translate-y-3 -mt-32 blur-effect w-[1.8rem] sm:w-[2.5rem] lg:w-[2.6rem] xl:w-[3rem]"></div>
          <div className="absolute bottom-[11.5rem] -left-[8.5rem] sm:bottom-[18rem] sm:-left-[14.1rem] md:bottom-[22.5rem] md:-left-[16rem] lg:-top-[15rem] lg:-left-[13rem] xl:-top-[14.5rem] xl:-left-[16rem] 2xl:-top-[16.5rem] 2xl:-left-[17rem] w-[2.8rem] sm:w-[3.5rem] md:w-[4rem] xl:w-[5rem]">
            <img
              src={reactP}
              alt="React Icon"
        ...
        <div className="">
          <div className="absolute right-[5.8rem] bottom-[2.5rem] sm:right-[8rem] sm:bottom-[3.5rem] md:right-[9rem] md:bottom-[3rem] lg:right-[9rem] lg:top-[3rem] xl:right-[11rem] xl:top-[7rem] 2xl:right-[13rem] 2xl:top-[10rem] -translate-x-3 translate-y-3 -mt-32 blur-effect w-[1.8rem] sm:w-[2.5rem] lg:w-[2.6rem] xl:w-[3rem]"></div>
          <div className="absolute right-[5.8rem] bottom-[-3.5rem] sm:right-[8.5rem] sm:bottom-[-1.6rem] md:right-[9rem] md:bottom-[-1.6rem] lg:right-[9rem] lg:top-[3rem] xl:right-[11rem] xl:top-[7rem] 2xl:right-[13rem] 2xl:top-[10rem]  w-[2.8rem] sm:w-[3.5rem] md:w-[4rem] xl:w-[5rem]">
            <img
              src={tailwindP}
              alt="Tailwind Icon"
        ...
        <div className="">
          <div className="absolute bottom-[15.8rem] left-[6.8rem] sm:bottom-[21rem] sm:left-[11.7rem] md:bottom-[26rem] md:left-[14rem] lg:top-[-20rem] lg:left-[10.5rem] xl:top-[-20rem] xl:left-[10.5rem] 2xl:top-[-20rem] 2xl:left-[12rem] translate-x-4 -translate-y-3 blur-effect w-[1.8rem] sm:w-[2.5rem] lg:w-[2.6rem] xl:w-[3rem]"></div>
          <div className="absolute bottom-[17rem] left-[7rem] sm:bottom-[22rem] sm:left-[12rem] md:bottom-[26rem] md:left-[14rem] lg:top-[-22rem] lg:left-[10.5rem] xl:top-[-22rem] xl:left-[10.5rem] 2xl:top-[-22rem] 2xl:left-[12rem] w-[2.8rem] sm:w-[3.5rem] md:w-[4rem] xl:w-[5rem]">
            <img
              src={javasriptP}
              alt="Javacript Icon"
        ...
        <div className="">
          <div className="absolute translate-y-3 -right-[7.9rem] bottom-[1rem] sm:-right-[15rem] sm:bottom-[3rem] md:-right-[16.5rem] md:bottom-[2.9rem] lg:-right-[13.5rem] lg:-top-[4rem] xl:-right-[15.5rem] xl:top-[0rem] 2xl:-right-[16.5rem] 2xl:top-[2rem] blur-effect w-[1.8rem] sm:w-[2.5rem] lg:w-[2.6rem] xl:w-[3rem]"></div>
          <div className="absolute -right-[8.5rem] bottom-[1rem] sm:-right-[15rem] sm:bottom-[2rem] md:-right-[17rem] md:bottom-[2rem] lg:-right-[14rem] lg:-top-[4rem] xl:-right-[16rem] xl:top-[0rem] 2xl:-right-[17rem] 2xl:top-[2rem] w-[2.5rem] sm:w-[3rem] md:w-[3.5rem] xl:w-[4.5rem]">
            <img
              src={cssP}
              alt="CSS Icon"
